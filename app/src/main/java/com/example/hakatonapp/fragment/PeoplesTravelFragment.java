...
import com.example.hakatonapp.adapter.PeoplesAdapter;
...
public class PeoplesTravelFragment extends Fragment {

    List<PeoplesData> data;
    ...
    private void visableAdapter(){
        ...
        if (data.isEmpty() || data ==null){
            Toast.makeText(getContext(), "Список попутчиков пуст!",Toast.LENGTH_LONG).show();
        } else {
            PeoplesAdapter adapter = new PeoplesAdapter(getContext(), data);
